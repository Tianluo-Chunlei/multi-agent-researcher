...
- When calling `add_citations`, pass both the report and the collected sources
- The citation agent will use this information to create accurate citations
- Sources should be passed as a list of URLs or source information objects
